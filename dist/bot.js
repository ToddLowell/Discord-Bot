...
client.on('message', (msg) => {
    ...
    if (msg.content.includes('what do you think of le chi') ||
    ...
    if (msg.content === 'entrancemusic') {
        ...
        channel
            ...
            const dispatcher = connection.play(require('path').join(__dirname, './Rocky Music Video-Eye Of The Tiger.mp3'));
            dispatcher.on('start', () => {
